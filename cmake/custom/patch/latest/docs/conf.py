...
html_theme_options = {
    ...
    "extra_navbar_items": {
        ...
        _("Community"): {
            ...
            _("Security"): {
                "description": _("Overview of Litestar's security protocols"),
        ...
        _("About"): {
            ...
            _("Releases"): {
                "description": _("Explore the release process, versioning, and deprecation policy for Litestar"),
                "link": "https://litestar.dev/about/litestar-releases",
                "icon": "releases",
            },
        },
        _("Release notes"): {
            _("What's new in 2.0"): "release-notes/whats-new-2",
        ...
        _("Help"): {
            _("Discord Help Forum"): {
                "description": _("Dedicated Discord help forum"),
                "link": "https://discord.gg/litestar",
                "icon": "coc",
            },
            _("GitHub Discussions"): {
                "description": _("GitHub Discussions"),
                "link": "https://github.com/orgs/litestar-org/discussions",
                "icon": "coc",
            },
            _("Stack Overflow"): {
                "description": _("We monitor the <code><b>litestar</b></code> tag on Stack Overflow"),
